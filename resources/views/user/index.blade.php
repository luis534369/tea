...
@section('content')
                ...
                <div class="slider_area">
                    <div class="slider_list  owl-carousel">
                        <div class="single_slide" style="background-image: url(/img/slider/1.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <div class="single_slide" style="background-image: url(/img/slider/2.jpg);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-12">
                                ...
                                <div class="shipping_list d-flex justify-content-between flex-xs-column">
                                    <div class="single_shipping_box d-flex">
                                        <div class="shipping_icon">
                                            <img src="/img/ship/1.png" alt="shipping icon">
                                        </div>
                                    ...
                                    <div class="single_shipping_box one d-flex">
                                        <div class="shipping_icon">
                                            <img src="/img/ship/2.png" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
                                            <h6>退货</h6>
                                            <p>7天之内退换货</p>
                                    ...
                                    <div class="single_shipping_box two d-flex">
                                        <div class="shipping_icon">
                                            <img src="/img/ship/3.png" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
                                            <h6>会员折扣</h6>
                                            <p>全天24小时在线支持</p>
                                    ...
                                    <div class="single_shipping_box three d-flex">
                                        <div class="shipping_icon">
                                            <img src="/img/ship/4.png" alt="shipping icon">
                                        </div>
                                        <div class="shipping_content">
                                            <h6>在线支持</h6>
                                            <p>所有订单免运费</p>
                                    ...
                                    <div class="section_title space_2 text-left">
                                     ...
                                     <div class="home_shop_product text-right">
                                        <ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist">
                                            ...
                                            <li><a href="#flowers" data-toggle="tab" role="tab" aria-selected="false" aria-controls="flowers"> 花卉 </a></li>
                                            <li><a href="#organics" data-toggle="tab" role="tab" aria-selected="false" aria-controls="organics">有机物 </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div> 
                                ...
                                <div class="shop_product_head d-flex justify-content-between mb-30">
                                    ...
                                    <div class="home_shop_product text-right">
                                        <ul class="product-tab-list nav d-flex flex-wrap justify-content-end" role="tablist">
                                            ...
                                            <li><a href="#cucumber " data-toggle="tab" role="tab" aria-selected="false" aria-controls="cucumber"> 黄瓜 </a></li>
                                            <li><a href="#tomato" data-toggle="tab" role="tab" aria-selected="false" aria-controls="tomato">番茄 </a></li>
                                            <li><a href="#banana" data-toggle="tab" role="tab" aria-selected="false" aria-controls="banana">香蕉 </a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
