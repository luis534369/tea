...
<head>
    ...
    <script src="{{asset('')}}/vendor/modernizr-2.8.3.min.js"></script>
</head>
<body>
                    ...
                    <div class="header_wrapper_inner">
                        ...
                        <div class="main_menu_inner">
                            ...
                            <div class="menu">
                                <nav>
                                    <ul>
                                        <li class="active"><a href="index.blade.php">首页 <i class="fa fa-angle-down"></i></a>
                                            <ul class="sub_menu">
                                        ...
                                        <li class="mega_parent"><a href="#">网页 <i class="fa fa-angle-down"></i></a>
                                            <ul class="mega_menu">
                                                <li class="mega_item">
                                ...
                                <div class="content-setting-dropdown">
                                    <div class="language-selector-wrapper">
                                        <div class="language-selector">
                                            <ul>
                                                <li><a href="#"><img src="/img/1.jpg" alt="English"><span class="expand-more">English</span></a></li>

                                                <li><a href="#"><img src="/img/banner/frances2.jpg" alt="Language"><span class="expand-more">Français</span> </a></li>
                    ...
                    <div class="single_footer widget">
                        <div class="single_footer_widget_inner">
                            ...
                            <div class="footer_content">
                                <p>地址: 123 Main Street, Anytown, CA 12345 - USA.</p>
                                <p>电话: +(000) 800 456 789</p>
                                <p>电子邮箱: Contact@posthemes.com</p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-xs-12">
                        <div class="footer_mastercard text-right">
                            <a href="#"><img src="/img/brand/payment.png" alt=""></a>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="product-flags madal">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="imgeone" role="tabpanel" >
                                        <div class="product_tab_img">
                                            <a href="#"><img src="/img/cart/nav12.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="imgetwo" role="tabpanel">
                                        <div class="product_tab_img">
                                            <a href="#"><img src="/img/cart/nav11.jpg" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="imgethree" role="tabpanel">
                                        <div class="product_tab_img">
                                            <a href="#"><img src="/img/cart/nav13.jpg" alt=""></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="products_tab_button  modals">
                                    <ul class="nav product_navactive" role="tablist">
                                        <li >
                                            <a class="nav-link active" data-toggle="tab" href="#imgeone" role="tab" aria-controls="imgeone" aria-selected="false"><img src="/img/cart/nav.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a class="nav-link" data-toggle="tab" href="#imgetwo" role="tab" aria-controls="imgetwo" aria-selected="false"><img src="/img/cart/nav1.jpg" alt=""></a>
                                        </li>
                                        <li>
                                            <a class="nav-link button_three" data-toggle="tab" href="#imgethree" role="tab" aria-controls="imgethree" aria-selected="false"><img src="/img/cart/nav2.jpg" alt=""></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
